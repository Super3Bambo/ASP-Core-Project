...
namespace ASPProject.Migrations
{
    ...
    [Migration("20210419205606_PremiumUsers")]
    partial class PremiumUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPProject.Models.UsersAnime", b =>
                {
                    b.HasOne("ASPProject.Models.Anime", "Anime")
                        .WithMany("UsersAnimeList")
                        .HasForeignKey("AnimeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPProject.Models.ApplicationUser", "User")
                        .WithMany("UsersAnimeList")
